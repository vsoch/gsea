# This script will run GSEA for a given input data, chip file, and class file.
# GSEA is run with the R package, the path to the main script must also be specified
...
GSEA.program.location <- gseadir   #  R source program (change pathname to the rigth location in local machine)
...
GSEA(
     ...
     #  Program parameters :----------------------------------------------------------------------------------------------------------------------------
     doc.string            = inputprefix, # Documentation string used as a prefix to name result files (default: "GSEA.analysis")
